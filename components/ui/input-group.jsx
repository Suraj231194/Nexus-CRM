...
function InputGroup({ className, ...props }) {
    return (<div data-slot="input-group" role="group" className={cn("group/input-group shadow-xs relative flex w-full items-center rounded-md border border-input outline-none transition-[color,box-shadow] dark:bg-input/30", "h-9 has-[>textarea]:h-auto", 
...
function InputGroupText({ className, ...props }) {
    return (<span className={cn("flex items-center gap-2 text-sm text-muted-foreground [&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none", className)} {...props}/>);
}

...
function ButtonGroupText({ className, asChild = false, ...props }) {
    ...
    return (<Comp className={cn("shadow-xs flex items-center gap-2 rounded-md border bg-muted px-4 text-sm font-medium [&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none", className)} {...props}/>);
}
